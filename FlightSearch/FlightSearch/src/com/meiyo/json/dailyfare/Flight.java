...
public class Flight {
	...
	public com.meiyo.json.dailyfare.Fare getLowestFare() {
		com.meiyo.json.dailyfare.Fare lowestFare = null;
		if (this.getRegularFare() != null) {
			for (com.meiyo.json.dailyfare.Fare thisFare : this.getRegularFare().getFares()) {
